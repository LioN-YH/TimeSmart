...
# INTRO：TimeSmart旧版本的run.py，适配于ts2img(显式转化成图像再读取张量)
...
if __name__ == "__main__":
    ...
    if args.is_training:
        for ii in range(args.itr):
            exp = Exp(args)
            setting = "{}_{}_{}_{}_{}_ft{}_ll{}_sl{}_pl{}_fs{}_dm{}_dp{}_{}_{}".format(
                args.task_name,
                args.vlm_type,
                args.model_id,
                args.model,
