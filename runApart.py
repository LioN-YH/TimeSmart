...
if __name__ == "__main__":
    ...
    # CHANGE：添加dset参数，用于指定数据集
    parser.add_argument("--dset", type=str, default="-", help="dataset name")
    ...
    parser.add_argument(
        ...
        type=str,
        default="CLIP",
        help="VLM model type, e.g. CLIP, BLIP2, etc.",
    )
    parser.add_argument(
        "--memory_bank_size", type=int, default=20, help="memory bank size"
    )
    parser.add_argument(
        "--patch_memory_size", type=int, default=100, help="patch memory bank size"
    )
    ...
    parser.add_argument(
        "--learnable_image", type=str2bool, default=True, help="learnable image"
    )
    ...
    parser.add_argument(
        ...
        type=str2bool,
        default=True,
        help="use cross attention to fuse image and text embeddings in customVLM",
    )
    parser.add_argument(
        "--w_out_visual", type=str2bool, default=False, help="without visual part"
    )
    parser.add_argument(
        "--w_out_text", type=str2bool, default=False, help="without text part"
    )
    parser.add_argument(
        "--w_out_query", type=str2bool, default=False, help="without query part"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--use_mem_gate", type=str2bool, default=False, help="use memory gate"
    )
    ...
    parser.add_argument(
        "--wo_ts", type=int, default=0, help="without/with Time Series Data 1/0"
    )

    # zero-shot forecasting
    parser.add_argument(
        "--target_data", type=str, default="ETTh2", help="target dataset type"
    )
    parser.add_argument(
        "--target_root_path",
        type=str,
        default="./data/ETT/",
        help="root path of the target data file",
    )
    parser.add_argument(
        "--target_data_path", type=str, default="ETTh2.csv", help="target data file"
    )
    ...
    parser.add_argument(
        ...
        type=float,
        default=1,
        help="proportion of in-distribution downstream dataset",
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=24,
        help="The dimensionality of meta-features",
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default="./Meta/",
        help="folder to save the meta features",
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=7,
        help="The number of methods for transforming time series into images",
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default="seg",
        help="Type of methods for transforming time series into images",
    )
    ...
    parser.add_argument(
        "--compress_vars",
        default=True,
        help="Compress the variable channels",
    )
    parser.add_argument(
        "--three_channel_image",
        type=str2bool,
        default=True,
        help="use three channel image",
    )
    parser.add_argument(
        "--save_images", type=str2bool, default=False, help="save images"
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=128,
        help="Window size for STFT_Transform",
    )
    parser.add_argument(
        "--stft_hop_length",
        type=int,
    ...
    parser.add_argument(
        ...
        type=bool,
        default=True,
        help="Whether to use logarithmic scale for certain transformations",
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default="morl",
        help="Wavelet type for Wavelet_Transform",
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=32,
        help="Number of frequency filters in the filterbank",
    )

    # mtf
    parser.add_argument(
        "--mtf_downsample_threshold",
        type=int,
        default=256,
        help="Maximum allowed time series length for full-resolution Markov Transition Field computation.",
    )
    parser.add_argument(
        "--use_fast_mode",
        action="store_true",
        default=False,
        help="Enable fast mode for MTF computation",
    )

    # fusor
    # NEED
    parser.add_argument(
        "--ts2img_fusion_strategy",
        type=str,
        default="select_best",
        help="Fusion strategy of transforming time series into images",
    )
