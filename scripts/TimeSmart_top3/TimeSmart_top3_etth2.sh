...
percent=1
train_epochs=30
results_path=TimeSmart_top3.txt
results_folder=./Result_top3/
...
# Create Logs_top3 directory if it doesn't exist
if [ ! -d "Logs_top3" ]; then
    mkdir Logs_top3
fi
...
run_experiment() {
    ...
    log_file="Logs_top3/${model_name}_${dset}_${seq_len}_${pred_len}_${percent}p_${ts2img_fusion_strategy}_${dropout}.log"
