...
percent=1
train_epochs=30
results_path=TimeVLM_wo.txt
results_folder=./Result_wo/

# Create Logs_wo directory if it doesn't exist
if [ ! -d "Logs_wo" ]; then
    mkdir Logs_wo
fi
...
run_experiment() {
    ...
    log_file="Logs_wo/${model_name}_${dset}_${seq_len}_${pred_len}_${percent}p.log"
