...
# run_experiment Electricity custom 321 192 24 0.1
# run_experiment Electricity custom 321 336 24 0.1
# run_experiment Electricity custom 321 720 24 0.1

# # Weather, n_vars=21, periodicity=144
# run_experiment Weather custom 21 96 144 0.1
# run_experiment Weather custom 21 192 144 0.1
# run_experiment Weather custom 21 336 144 0.1
# run_experiment Weather custom 21 720 144 0.1

# Traffic, n_vars=862, periodicity=24
run_experiment Traffic custom 862 96 24 0.1
run_experiment Traffic custom 862 192 24 0.1
run_experiment Traffic custom 862 336 24 0.1
run_experiment Traffic custom 862 720 24 0.1
